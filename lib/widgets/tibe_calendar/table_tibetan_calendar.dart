...
import 'package:my_calendar/widgets/table_calendar/src/customization/days_of_week_style_phone.dart';
import 'package:my_calendar/widgets/table_calendar/src/customization/header_style_phone.dart';
import 'package:my_calendar/widgets/table_calendar/src/shared/utils_phone.dart';
import 'package:my_calendar/widgets/table_calendar/src/widgets/calendar_header_phone.dart';
import 'package:my_calendar/widgets/table_calendar/table_calendar_base_phone.dart';

import 'package:my_calendar/widgets/tibe_calendar/cell_content_tibetan.dart';
...
class TableTibetanCalendarPhone<T> extends StatefulWidget {
  ...
  @override
  _TableTibetanCalendarPhoneState<T> createState() => _TableTibetanCalendarPhoneState<T>();
}

class _TableTibetanCalendarPhoneState<T> extends State<TableTibetanCalendarPhone<T>> {
  ...
  @override
  void didUpdateWidget(TableTibetanCalendarPhone<T> oldWidget) {
  ...
  void _swipeCalendarFormat(SwipeDirection direction) {
    if (widget.onFormatChanged != null) {
      ...
      if (widget.verticalSwipe) widget.onFormatChanged!(formats[id]);
    }
  }
  ...
  Widget _buildCell(DateTime day, DateTime focusedDay) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content = CellContentTibe(
