...
import 'package:my_calendar/widgets/table_calendar/src/widgets/calendar_page_phone.dart';

class CalendarCore extends StatelessWidget {
  const CalendarCore({Key? key, 
    ...
    this.tableBorder,
    this.scrollPhysics,
  }) : assert(!dowVisible || (dowHeight != null && dowBuilder != null)), super(key: key);
