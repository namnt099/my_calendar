...
class CungGiap extends StatefulWidget {
  const CungGiap({
    Key? key,
    required this.index,
  ...
  @override
  State<CungGiap> createState() => _CungGiapState();
}

class _CungGiapState extends State<CungGiap> {
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                itemLeaf(thapNhiCung: widget.horoScope.thapNhiCung[index3]),
              ],
            ),
          ),
          Row(
